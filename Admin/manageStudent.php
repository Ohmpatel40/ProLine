                ...
                <table class="table align-items-center mb-0">
                  ...
                  <?php
                    ...
                    if(isset($_POST['search']))
                    {
                        ...
                        if($_POST['Course'] != "")
                        {
                            array_push($filter_array,"Course='".$_POST['Course']."'");
                        }
                        if($_POST['Semester'] != "")
                        {
                            array_push($filter_array,"Semester='".$_POST['Semester']."'");
                        }
                        $filter = implode(" and ",$filter_array);
                    
                        $q = "select * from stud_details where ".$filter;
                                ...
                                echo '     
                                    <tr>
                                        ...
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                            <img src="./Student_Photo/'.$res['Photo'].'" class="avatar avatar-sm me-3" alt="user1">
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-xs text-secondary mb-0">'.$res['Semester'].' Semester </p>
                                        </td>
                                        <td>
                                        ...
                                        <td class="align-middle">
                                            <a href="fullStudentDetail.php?SID='.$res['SID'].'" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                View Full Details
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        else
                        {
                            ...
                            <tr>
                                <td colspan="4" class="text-center">
                                    <p class="text-xs font-weight-bold mb-0"> NO STUDENT FOUND </p>
                                </td>
                            </tr>
                            ';
                        } 
